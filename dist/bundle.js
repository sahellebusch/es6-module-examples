...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Beer = __webpack_require__(1);
	...
	var _template2 = __webpack_require__(2);

	var _template3 = _interopRequireDefault(_template2);

	var _each2 = __webpack_require__(71);
	...
	(0, _jquery2.default)(function () {
	    ...
	    var beers = [];
	    var summary = (0, _template3.default)('<p><%= summary %></p>');

	    beers.push(new _Beer2.default('Schlafly Oktoberfest', 'ale', 40, 6.2));
	    beers.push(new _Beer2.default('Odell Runoff Red IPA', 'ale', 50, 6.5));
	    beers.push(new _Beer2.default('North Coast Scrimshaw', 'lager', 22, 4.7));

	    (0, _each3.default)(beers, function (beer) {
	        var $par = (0, _jquery2.default)(summary({ summary: beer.getSummary() }));
	        $body.append($par);
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var summary = (0, _template3.default)("<%= name %> is an <%= family %> with <%= IBU %> IBUs and <%= alcohol %>% alcohol.");

	var Beer = function () {
	    function Beer(name, family, IBU, alcohol) {
	        ...
	        function _validateFamily(family) {
	            if (family !== 'ale' && family !== 'lager') throw Error("Family must be either an ale or a lager");
	        }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataView = __webpack_require__(125),
	    ...
	    baseGetTag = __webpack_require__(129),
	    toSource = __webpack_require__(18);
